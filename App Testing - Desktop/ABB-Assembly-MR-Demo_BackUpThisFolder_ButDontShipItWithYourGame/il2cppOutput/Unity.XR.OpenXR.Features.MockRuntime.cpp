...
{
	{
		//<source_info:./Library/PackageCache/com.unity.xr.openxr@ef0033a586bf/Runtime/MockRuntime/MockRuntime.cs:668>
		return (bool)0;
	}
}
...
{
	{
		//<source_info:./Library/PackageCache/com.unity.xr.openxr@ef0033a586bf/Runtime/MockRuntime/MockRuntime.cs:677>
		return ((int64_t)0);
	}
}
